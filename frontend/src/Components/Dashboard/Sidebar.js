  ...
  const getSidebarItems = () => {
    switch (userRole) {
      ...
      case 'rregistrationdepartment':
        return [
          { text: 'DashBoard', icon: <GridViewIcon />, path: '/' },  //this url want to change according to the user location
          { text: 'Vehicles', icon: <DirectionsCarFilledIcon />, path: '' }, //this url want to fetch all vehicle details 
          { text: 'revenue detailes', icon: <GroupsIcon />, path: '/drivers'  },  //this url want to fetch all Driver details 
          { text: 'Fines', icon: <LibraryBooksIcon />, path: '/exams' },  
          { text: 'Court', icon: <AddToDriveIcon />, path: '/practical-test' },
          { text: 'About Us', icon: <EmojiTransportationIcon />, path: '/about-us' },
          { text: 'Setting', icon: <SettingsIcon />, path: '/settings' },
